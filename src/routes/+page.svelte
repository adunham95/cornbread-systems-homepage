<script>
	import icon_logo from '$lib/images/icon.svg';
	import text_logo from '$lib/images/logo-text.svg';
</script>

<svelte:head>
	<title>Cornbread Systems</title>
</svelte:head>
...
<div class="bg-white">
		...
		>
			<div class="flex lg:flex-1">
				<a href="/" class="-m-1.5 p-1.5 flex items-center">
					...
					<img class="h-14 w-auto" src={icon_logo} alt="" />
					<img class="h-8 w-auto" src={text_logo} alt="" />
				</a>
			</div>
	...
	<footer class="mx-auto mt-40 max-w-7xl overflow-hidden px-6 pb-20 sm:mt-64 sm:pb-24 lg:px-8">
		...
		<p class="mt-10 text-center text-xs leading-5 text-gray-500">
			&copy; {new Date().getFullYear()} Cornbread Systems LLC. All rights reserved.
		</p>
	</footer>
</div>
